...
| File | Status | Role |
|---|---|---|
| `mms-remote-bridge/src/codex-desktop-refresher.js` | ✏️ Modified | Keeps pending completion refreshes alive until they actually run |
| `mms-remote-bridge/test/codex-desktop-refresher.test.js` | ✏️ Modified | Covers the slow-refresh + queued-completion regression |
