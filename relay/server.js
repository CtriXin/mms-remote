// FILE: server.js
// Purpose: Hosts the public MMS Remote relay plus optional push-notification HTTP endpoints.
...
if (require.main === module) {
  ...
  const trustProxy = readOptionalBooleanEnv(["MMS_REMOTE_TRUST_PROXY"]) ?? false;
  const enablePushService = readOptionalBooleanEnv(
    ["MMS_REMOTE_ENABLE_PUSH_SERVICE"]
  ) ?? false;
