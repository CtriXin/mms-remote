// FILE: relay.js
// Purpose: Thin self-hostable WebSocket relay for MMS Remote pairing, trusted-session lookup, and encrypted forwarding.
...
const TRUSTED_SESSION_RESOLVE_TAG = "mms-remote-trusted-session-resolve-v1";
