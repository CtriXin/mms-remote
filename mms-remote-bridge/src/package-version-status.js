...
// Purpose: Reads the installed MMS Remote package version and caches the latest published npm version.
// Layer: CLI helper
...
const MMS_REMOTE_REGISTRY_URL = "https://registry.npmjs.org/mms-remote/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = MMS_REMOTE_REGISTRY_URL,
