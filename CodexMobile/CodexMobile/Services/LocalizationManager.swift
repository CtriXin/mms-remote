...
enum Strings {
    static let table: [AppLanguage: [String: String]] = [
        .chinese: [
            ...
            // WhatsNew
            "whatsnew.title": "新功能",
            "whatsnew.1": "新版 MMS Remote CLI v1.5.0",
            "whatsnew.2": "新消息气泡颜色",
            "whatsnew.3": "图像生成已可用",
            "whatsnew.4": "编辑器中的插件引用",
            "whatsnew.5": "AI 起草的提交和 PR",
            "whatsnew.6": "逐文件差异钻取",
            "whatsnew.7": "带实时进度的 Git 发布",
            "whatsnew.8": "Windows 主机配对",
            "whatsnew.9": "带自动标题的固定话题",
            "whatsnew.10": "新 /compact 斜杠命令",
            "whatsnew.11": "更清爽的计划模式时间线",
            "whatsnew.12": "新聊天的本地文件夹浏览",
            "whatsnew.13": "更安全的工作区图像预览",
            "whatsnew.14": "更精准的 skill 和文件自动补全",
            "whatsnew.15": "兑换码",
            "whatsnew.16": "刷新的侧边栏和设置",
            "whatsnew.17": "更流畅的流式传输和滚动",
            "whatsnew.18": "新的可拖拽宠物伴侣",
            "whatsnew.19": "更可靠的重连",
            "whatsnew.20": "大量 Bug 修复 — 计划模式、间距、延迟",
        ...
        .english: [
            ...
            "whatsnew.1": "New MMS Remote CLI v1.5.0",
            "whatsnew.2": "New message bubble colors",
            "whatsnew.3": "Image Gen is now available",
            "whatsnew.4": "Plugin mentions in the composer",
            "whatsnew.5": "AI-drafted commits and PRs",
            "whatsnew.6": "Per-file diff drilldown",
            "whatsnew.7": "Stacked Git publish with live progress",
            "whatsnew.8": "Windows host pairing",
            "whatsnew.9": "Pinned threads with auto titles",
            "whatsnew.10": "New `/compact` slash command",
            "whatsnew.11": "Cleaner Plan Mode timeline",
            "whatsnew.12": "Local folder browser for new chats",
            "whatsnew.13": "Safer workspace image previews",
            "whatsnew.14": "Sharper skill and file autocomplete",
            "whatsnew.15": "Offer code redemption",
            "whatsnew.16": "Refreshed sidebar and Settings",
            "whatsnew.17": "Smoother streaming and scrolling",
            "whatsnew.18": "New draggable pet companion",
            "whatsnew.19": "More reliable reconnect",
            "whatsnew.20": "Lots of bug fixes — Plan Mode, padding, lag",
