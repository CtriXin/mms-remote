...
enum Strings {
    static let table: [AppLanguage: [String: String]] = [
        .chinese: [
            ...
            "swift_terminal.sidebar.title": "Terminal 会话",
            "swift_terminal.sidebar.count": "%d 个窗格",
            "swift_terminal.sidebar.current": "当前",
            "swift_terminal.sidebar.empty_hint": "连接 Mac Bridge 后，可在这里创建或切换 tmux 窗格。",
            ...
            "mmschat.error_bridge_mismatch": "Mac Bridge 版本或能力不匹配，可能过旧。请在 Mac 上更新并重启 Bridge，然后重新配对后再试。",
            "mmschat.error_connection_lost": "与 Mac Bridge 的连接已中断或超时。请确认 Mac 在线并重启 Bridge，然后重新连接后再试。",
            "mmschat.error_generic": "MMSChat 暂时不可用，请稍后重试。",
            "mmschat.retry": "重试",
            ...
            "mmschat.tool.name": "名称",
            "mmschat.tool.command": "命令",
            "mmschat.tool.cwd": "工作目录",
            "mmschat.tool.input": "输入",
            "mmschat.tool.call": "工具调用",
            "mmschat.tool.result": "工具结果",
            "mmschat.tool.result_error": "工具错误",
            ...
            "mmschat.model_picker.open": "新建 MMSChat",
            "mmschat.model_picker.open_hint": "打开新建 MMSChat 与启动预览，不会刷新列表",
            ...
            "mmschat.empty_action_refresh": "刷新",
            ...
            "mmschat.detail.cache_clear": "清除缓存",
            "mmschat.detail.cache_clear_confirm_title": "清除缓存？",
            "mmschat.detail.cache_clear_confirm_message": "这将清除该会话的对话记录缓存。此操作不可撤销。",
            "mmschat.detail.cache_clear_success": "缓存已清除",
            "mmschat.detail.cache_clear_error": "清除缓存失败",
            "mmschat.model_picker.no_config_title": "未找到配置",
            "mmschat.model_picker.no_config_description": "在 Mac 上未检测到 MMS 配置文件。请检查 ~/.mms/config.yaml 或环境变量。",
            "mmschat.model_picker.no_providers_title": "没有可用 Provider",
            "mmschat.model_picker.no_providers_description": "配置中未找到可用的模型 Provider。请检查凭据和配置。",
        ...
        .english: [
            ...
            "swift_terminal.sidebar.title": "Terminal Sessions",
            "swift_terminal.sidebar.count": "%d panes",
            "swift_terminal.sidebar.current": "Current",
            "swift_terminal.sidebar.empty_hint": "Connect to your Mac Bridge, then create or switch tmux panes here.",
            ...
            "mmschat.error_bridge_mismatch": "Your Mac Bridge is too old or missing MMSChat capabilities. Update and restart the Bridge on your Mac, then pair again and retry.",
            "mmschat.error_connection_lost": "The connection to your Mac Bridge was lost or timed out. Make sure your Mac is online, restart the Bridge, then reconnect and retry.",
            "mmschat.error_generic": "MMSChat is temporarily unavailable. Please try again.",
            "mmschat.retry": "Retry",
            ...
            "mmschat.tool.name": "Name",
            "mmschat.tool.command": "Command",
            "mmschat.tool.cwd": "Working Directory",
            "mmschat.tool.input": "Input",
            "mmschat.tool.call": "Tool Call",
            "mmschat.tool.result": "Tool Result",
            "mmschat.tool.result_error": "Tool Error",
            ...
            "mmschat.tab.sessions": "Sessions",
            "mmschat.model_picker.open": "New MMSChat",
            "mmschat.model_picker.open_hint": "Open New MMSChat and launch preview; this does not refresh the list",
            ...
            "mmschat.empty_action_refresh": "Refresh",
            ...
            "mmschat.detail.cache_clear": "Clear Cache",
            "mmschat.detail.cache_clear_confirm_title": "Clear cache?",
            "mmschat.detail.cache_clear_confirm_message": "This will clear the transcript cache for this session. This action cannot be undone.",
            "mmschat.detail.cache_clear_success": "Cache cleared",
            "mmschat.detail.cache_clear_error": "Failed to clear cache",
            "mmschat.model_picker.no_config_title": "No config found",
            "mmschat.model_picker.no_config_description": "No MMS config file detected on Mac. Check ~/.mms/config.yaml or environment variables.",
            "mmschat.model_picker.no_providers_title": "No providers available",
            "mmschat.model_picker.no_providers_description": "No model providers found in config. Check credentials and configuration.",
