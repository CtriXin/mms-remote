...
enum Strings {
    static let table: [AppLanguage: [String: String]] = [
        .chinese: [
            ...
            "settings.about": "关于",
            "connection.recovery.title": "连接",
            "connection.recovery.status.interrupted": "已中断",
            "connection.recovery.status.reconnecting": "重连中",
            "connection.recovery.status.action_required": "需要操作",
            "connection.recovery.status.syncing": "同步中",
            "connection.recovery.accessibility.action": "打开建议的恢复操作",
            "connection.recovery.accessibility.status": "显示当前恢复状态",
            ...
            "terminal.reconnect.summary": "连接已中断，点 Reconnect 重新连接 Mac。",
            "terminal.reconnect.progress": "正在重新连接你的 Mac。",
        ...
        .english: [
            ...
            "connection.recovery.title": "Connection",
            "connection.recovery.status.interrupted": "Interrupted",
            "connection.recovery.status.reconnecting": "Reconnecting",
            "connection.recovery.status.action_required": "Action Needed",
            "connection.recovery.status.syncing": "Syncing",
            "connection.recovery.accessibility.action": "Opens the suggested recovery action",
            "connection.recovery.accessibility.status": "Shows the current recovery status",
            ...
            "terminal.reconnect.summary": "Connection was interrupted. Tap Reconnect to try your Mac again.",
            "terminal.reconnect.progress": "Trying to reconnect to your Mac.",
            "terminal.reconnect.action": "Reconnect",
