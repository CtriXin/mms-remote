...
enum Strings {
    static let table: [AppLanguage: [String: String]] = [
        .chinese: [
            ...
            "settings.about": "关于",
            "settings.codex_chat": "Codex 聊天",
            "settings.chatgpt_voice_mode": "ChatGPT 语音模式",
            "settings.chat_font_size": "聊天字号 %d",
            "settings.chat_font_size_hint": "只调整 Codex 聊天消息文字；Terminal 字号在 Terminal 设置中单独控制。",
            "settings.model": "模型",
            "settings.auto": "自动",
            ...
            "terminal.settings.font_size": "Terminal 默认字号 %d",
            "terminal.settings.font_size_hint": "设置 Terminal 默认字号；工具栏字号只影响当前 Terminal 视图。",
            ...
            "sidebar.select": "选择",
            "sidebar.done": "完成",
            "sidebar.collapse_subagents": "折叠子代理",
            "sidebar.expand_subagents": "展开子代理",
            "sidebar.subagent": "子代理",
            "sidebar.connected_computer": "已连接电脑",
            "sidebar.saved_computer": "已保存电脑",
            "sidebar.detached_worktree": "从默认分支分离的工作树。",
            "sidebar.pinned": "已固定",
            "sidebar.archived_count": "已归档 (%d)",
            "sidebar.cloud": "云端",

            // WhatsNew
            "whatsnew.title": "新功能",
            "whatsnew.1": "全应用多语言支持（简体中文 + 英文）",
            "whatsnew.2": "MMS Chat 云聊天与实时续接",
            "whatsnew.3": "Terminal Pane Sheet 与 SwiftTerm 渲染器",
            "whatsnew.4": "Terminal 侧边栏抽屉管理窗格",
            "whatsnew.5": "Session Drawer 底部操作栏重构",
            "whatsnew.6": "Terminal 方向键与快捷键工具栏",
            "whatsnew.7": "Bridge 版本兼容性检查",
            "whatsnew.8": "手机端实时 Compose 操作",
            "whatsnew.9": "Terminal 深色画布与字体偏好",
            "whatsnew.10": "更可靠的重连与恢复机制",
            "whatsnew.11": "AI 起草的提交与 PR",
            "whatsnew.12": "逐文件差异钻取",
            "whatsnew.13": "带自动标题的固定话题",
            "whatsnew.14": "新聊天的本地文件夹浏览",
            "whatsnew.15": "更安全的工作区图像预览",
            "whatsnew.16": "更精准的 skill 和文件自动补全",
            "whatsnew.17": "兑换码",
            "whatsnew.18": "刷新的侧边栏和设置",
            "whatsnew.19": "更流畅的流式传输与滚动",
            "whatsnew.20": "新的可拖拽宠物伴侣",
            ...
            "swift_terminal.error_title": "终端错误",
            "swift_terminal.panes": "窗格",
            "swift_terminal.focus": "输入",
            "swift_terminal.hide_keyboard": "收键盘",
            "swift_terminal.command_placeholder": "输入命令...",
            "swift_terminal.bracketed_paste": "安全粘贴",
            "swift_terminal.font_size": "字号 %d",
            "swift_terminal.no_pane": "没有终端窗格",
            "swift_terminal.no_pane_hint": "这里使用新的 Swift renderer；如果异常，可在设置里打开旧版终端 fallback。",
            "swift_terminal.create": "创建终端",
            "swift_terminal.sidebar.title": "终端窗格",
            ...
            "swift_terminal.sidebar.empty_hint": "连接 Mac Bridge 后可在这里切换终端窗格。",
            ...
            "swift_terminal.direction_pad": "方向键",
            "swift_terminal.direction_pad_hint": "轻点向右，拖动选择上下左右，按住拖动会连续发送。",
            ...
            "swift_terminal.renderer_stable_short": "稳定",
            ...
            "swift_terminal.shortcuts_bad_item": "每个快捷键都需要标签和值。",
            ...
            "turn.codex_requesting_permission": "Codex 请求继续的权限。",
            "common.refreshing": "刷新中...",
            "usage.percent_left": "%d%% 剩余",
            "issue.report": "报告问题",
            "issue.dismiss": "忽略问题",
            ...
            "connection.still_connecting": "仍在连接中…",
            "connection.interrupted": "已中断",
            "connection.action_needed": "需要操作",
            "connection.title": "连接",
            "connection.hint_actionable": "打开建议的恢复操作",
            "connection.hint_status": "显示当前恢复状态",
            "connection.preparing_reconnect": "正在准备重连...",
            "connection.reconnect_failed": "无法重连。点击重连再试一次。",
            "connection.timed_out": "连接超时，正在重试...",
            "connection.trusted_reconnect_unavailable": "此中继端点不可用受信任重连。请更新或检查中继/代理，然后重连。仅在此 Mac 重置后才扫描新的二维码。",
            "connection.disconnect": "断开连接",

            // Pairing
            "pairing.error": "配对错误",
            "pairing.enter_code": "输入配对码",
            ...
            // Turn
            "turn.handoff_local": "移交给本地",
            "turn.handoff_worktree": "移交给工作树",
            "turn.git_error": "Git 错误",
            "turn.no_changes": "没有可显示的仓库更改。",
            "turn.could_not_load_changes": "无法加载仓库更改。",
            "turn.view_pr": "查看 PR",
            "turn.tap_view_pr": "点击查看 PR 打开拉取请求。",
            "turn.closing": "关闭中...",
            "turn.local_handoff_failed": "本地移交失败",
            "turn.worktree_handoff_failed": "工作树移交失败",
            "turn.could_not_handoff_local": "无法将话题移交回本地。",
            "turn.could_not_handoff_worktree": "无法将话题移交到新工作树。",
            "turn.branch_exists": "分支已存在",
            "turn.branch_exists_msg": "工作树 '%@' 已存在。请选择其他名称。",
            "turn.local_fork_unavailable": "本地分叉不可用",
            "turn.local_fork_worktree_hint": "无法解析此工作树话题的本地检出。",
            "turn.local_fork_hint": "无法解析此话题的本地项目路径。",
            "turn.repository_changes": "仓库更改",
            "turn.collapse_all": "全部折叠",
            "turn.expand_all": "全部展开",
            "turn.handoff_worktree_title": "将话题移交到工作树",
            "turn.fork_worktree_title": "将话题分叉到新工作树",
            "turn.handoff": "移交",
            "turn.fork": "分叉",
            "turn.handoff_desc": "在新工作树中创建并检出分支以并行继续。分支名会加上 mms-remote/ 前缀。",
            "turn.fork_desc": "在新工作树中创建并检出分支，然后将此对话分叉到该检出中作为新聊天。",
            "turn.subagents": "子代理",
            "turn.remove_subagents": "移除子代理",
            "turn.code_review": "代码审查: %@",
            "turn.remove_code_review": "移除代码审查",
            "turn.voice_start": "开始语音转文字",
            "turn.planning": "规划中...",
            "turn.plan": "计划",
            "turn.pending": "待处理",
            "turn.in_progress": "进行中",
            "turn.completed": "已完成",
            "turn.next_step": "下一步",
            "turn.next_step_prompt": "Codex 接下来应该做什么？",
            "turn.requested_model": "请求的模型",
            "turn.model": "模型",
            "turn.ask_placeholder": "问任何问题… @plugins, $skills, /commands",
            "turn.followup_placeholder": "请求后续更改",
            ...
            // Subagent Status
            "subagent.starting": "正在启动子话题",
            "subagent.created": "子话题已创建",
            "subagent.create_failed": "无法创建子话题",
            "subagent.spawn_interrupted": "启动已中断",
            "subagent.queued": "排队等待启动",
            "subagent.preparing": "正在准备子话题",
            "subagent.working": "仍在工作中",
            "subagent.finished": "已完成",
            "subagent.finished_error": "完成但有错误",
            "subagent.stopped": "提前停止",
            "subagent.waiting": "等待更新",
            "subagent.processing": "正在处理新指令",
            "subagent.processed": "已处理更新",
            "subagent.update_failed": "更新失败",
            "subagent.update_interrupted": "更新已中断",
            "subagent.queued_update": "更新排队中",
            "subagent.instructions_sent": "指令已发送",
            "subagent.back_to_work": "回到工作中",
            "subagent.resumed_completed": "已恢复并完成",
            "subagent.resume_failed": "恢复失败",
            "subagent.resume_interrupted": "恢复已中断",
            "subagent.queued_resume": "排队恢复中",
            "subagent.resuming": "正在恢复代理",
            "subagent.closing": "关闭中",
            "subagent.closed": "已关闭",
            "subagent.close_failed": "关闭失败",
            "subagent.close_interrupted": "关闭已中断",
            "subagent.queued_close": "排队关闭中",
            "subagent.closing_agent": "正在关闭代理",
            "subagent.working_now": "正在工作",
            "subagent.ended_error": "异常结束",
            "subagent.idle": "空闲",

            // Onboarding
            "onboarding.install_codex": "安装 Codex CLI",
            "onboarding.install_codex_desc": "在终端中运行的 AI 编程助手。MMS Remote 从 iPhone 连接到它。",
            "onboarding.install_bridge": "安装 Bridge",
            "onboarding.install_bridge_desc": "轻量级中继，安全地将 Mac 连接到 iPhone。",
            "onboarding.start_pairing": "开始配对",
            "onboarding.start_pairing_desc": "在电脑上运行此命令。终端中会出现二维码…",
            "onboarding.scan_qr": "扫描二维码",
            "onboarding.pair_with_code": "输入配对码",
            "onboarding.get_started": "开始使用",
            "onboarding.set_up": "设置",
            "onboarding.continue": "继续",
            "onboarding.continue_anyway": "仍继续",
            "onboarding.step": "第 %d 步",
            "onboarding.control_codex": "从 iPhone 控制 Codex。",
            "onboarding.e2ee": "端到端加密",
            "onboarding.what_you_get": "你将获得",
            "onboarding.everything_local": "一切运行在你的电脑上。\n你的手机是遥控器。",
            "onboarding.feature.fast": "快速模式",
            "onboarding.feature.git": "用手机操作 Git",
            "onboarding.feature.e2ee": "端到端加密",
            "onboarding.feature.voice": "语音模式",
            "onboarding.feature.subagents": "子代理、skills 和 /commands",
            "onboarding.install_codex_first": "请先安装 Codex CLI",
            "onboarding.install_codex_hint": "在电脑上粘贴运行 \"%@\" 来安装。MMS Remote 在 Codex CLI 安装并可用之前无法工作。",
            "onboarding.bridge_caption": "MMS Remote 可以在桥接运行时用 macOS caffeinate 保持 Mac 唤醒，但默认关闭。你可以在设置中启用。",
            ...
            "paywall.feature.fast.description": "低延迟交互，快速响应",
            "paywall.feature.git.description": "提交、推送、拉取和切换分支",
            "paywall.feature.e2ee.description": "中继看不到你的提示和代码",
            "paywall.feature.voice.description": "用语音转文字与 Codex 对话",
            "paywall.feature.subagents.description": "从手机生成和监控并行代理",
            "paywall.feature.skills.description": "调用 skills、运行斜杠命令和内联引用文件",
            "paywall.feature.relay.description": "你为产品和托管路径付费",
            "paywall.feature.support.description": "帮助保持 MMS Remote 独立和开源",
        ...
        .english: [
            ...
            "settings.codex_chat": "Codex Chat",
            "settings.chatgpt_voice_mode": "ChatGPT voice mode",
            "settings.chat_font_size": "Chat Size %d",
            "settings.chat_font_size_hint": "Adjusts Codex chat message text only; Terminal size is controlled separately in Terminal settings.",
            ...
            "terminal.settings.font_size": "Terminal Default Size %d",
            "terminal.settings.font_size_hint": "Sets the default Terminal size; the toolbar size control only changes the current Terminal view.",
            ...
            "sidebar.done": "Done",
            "sidebar.collapse_subagents": "Collapse subagents",
            "sidebar.expand_subagents": "Expand subagents",
            "sidebar.subagent": "Subagent",
            "sidebar.connected_computer": "Connected to Computer",
            "sidebar.saved_computer": "Saved Computer",
            "sidebar.detached_worktree": "Detached worktree from the default branch.",
            "sidebar.pinned": "Pinned",
            "sidebar.archived_count": "Archived (%d)",
            "sidebar.cloud": "Cloud",

            // WhatsNew
            "whatsnew.title": "What's New",
            "whatsnew.1": "Full app localization (Simplified Chinese + English)",
            "whatsnew.2": "MMS Chat cloud chat with live continuation",
            "whatsnew.3": "Terminal Pane Sheet with SwiftTerm renderer",
            "whatsnew.4": "Terminal sidebar drawer for pane management",
            "whatsnew.5": "Session Drawer with bottom bar actions",
            "whatsnew.6": "Terminal direction pad and shortcut toolbar",
            "whatsnew.7": "Bridge version guard for compatibility",
            "whatsnew.8": "Phone live compose actions in chat",
            "whatsnew.9": "Terminal dark canvas and font preferences",
            "whatsnew.10": "More reliable reconnection and recovery",
            "whatsnew.11": "AI-drafted commits and PRs",
            "whatsnew.12": "Per-file diff drilldown",
            "whatsnew.13": "Pinned threads with auto titles",
            "whatsnew.14": "Local folder browser for new chats",
            "whatsnew.15": "Safer workspace image previews",
            "whatsnew.16": "Sharper skill and file autocomplete",
            "whatsnew.17": "Offer code redemption",
            "whatsnew.18": "Refreshed sidebar and Settings",
            "whatsnew.19": "Smoother streaming and scrolling",
            "whatsnew.20": "New draggable pet companion",
            ...
            "swift_terminal.direction_pad": "Arrow pad",
            "swift_terminal.direction_pad_hint": "Tap for right, drag for arrows, hold while dragging to repeat.",
            ...
            "turn.codex_requesting_permission": "Codex is requesting permission to continue.",
            "common.refreshing": "Refreshing...",
            "usage.percent_left": "%d%% left",
            ...
            "connection.still_connecting": "Still connecting…",
            "connection.interrupted": "Interrupted",
            "connection.action_needed": "Action Needed",
            "connection.title": "Connection",
            "connection.hint_actionable": "Opens the suggested recovery action",
            "connection.hint_status": "Shows the current recovery status",
            "connection.preparing_reconnect": "Preparing reconnect...",
            "connection.reconnect_failed": "Could not reconnect. Tap Reconnect to try again.",
            "connection.timed_out": "Connection timed out. Retrying...",
            "connection.trusted_reconnect_unavailable": "Trusted reconnect is unavailable from this relay endpoint. Update or check the relay/proxy, then reconnect. Scan a new QR code only if this Mac was reset.",
            "connection.disconnect": "Disconnect",

            // Pairing
            "pairing.error": "Pairing Error",
            "pairing.enter_code": "Enter Pairing Code",
            ...
            // Turn
            "turn.handoff_local": "Hand off to Local",
            "turn.handoff_worktree": "Hand off to Worktree",
            "turn.git_error": "Git Error",
            "turn.no_changes": "There are no repository changes to show.",
            "turn.could_not_load_changes": "Could not load repository changes.",
            "turn.view_pr": "View PR",
            "turn.tap_view_pr": "Tap View PR to open the pull request.",
            "turn.closing": "Closing...",
            "turn.local_handoff_failed": "Local Handoff Failed",
            "turn.worktree_handoff_failed": "Worktree Handoff Failed",
            "turn.could_not_handoff_local": "Could not hand off the thread back to Local.",
            "turn.could_not_handoff_worktree": "Could not hand off the thread to the new worktree.",
            "turn.branch_exists": "Branch Already Exists",
            "turn.branch_exists_msg": "A worktree for '%@' already exists. Choose a different name.",
            "turn.local_fork_unavailable": "Local Fork Unavailable",
            "turn.local_fork_worktree_hint": "Could not resolve the Local checkout for this worktree thread.",
            "turn.local_fork_hint": "Could not resolve the local project path for this thread.",
            "turn.repository_changes": "Repository Changes",
            "turn.collapse_all": "Collapse All",
            "turn.expand_all": "Expand All",
            "turn.handoff_worktree_title": "Hand off thread to worktree",
            "turn.fork_worktree_title": "Fork thread into new worktree",
            "turn.handoff": "Hand off",
            "turn.fork": "Fork",
            "turn.handoff_desc": "Create and check out a branch in a new worktree to continue in parallel. The branch is normalized with the mms-remote/ prefix.",
            "turn.fork_desc": "Create and check out a branch in a new worktree, then fork this conversation into that checkout as a new chat.",
            "turn.subagents": "Subagents",
            "turn.remove_subagents": "Remove subagents",
            "turn.code_review": "Code Review: %@",
            "turn.remove_code_review": "Remove code review",
            "turn.voice_start": "Start voice transcription",
            "turn.planning": "Planning...",
            "turn.plan": "Plan",
            "turn.pending": "Pending",
            "turn.in_progress": "In progress",
            "turn.completed": "Completed",
            "turn.next_step": "Next step",
            "turn.next_step_prompt": "What should Codex produce next?",
            "turn.requested_model": "Requested model",
            "turn.model": "Model",
            "turn.ask_placeholder": "Ask anything... @plugins, $skills, /commands",
            "turn.followup_placeholder": "Ask for follow-up changes",

            // Command Verbs
            "cmd.reading": "Reading",
            "cmd.read": "Read",
            "cmd.searching": "Searching",
            "cmd.searched": "Searched",
            "cmd.listing": "Listing",
            "cmd.listed": "Listed",
            "cmd.finding": "Finding",
            "cmd.found": "Found",
            ...
            // Subagent Status
            "subagent.starting": "Starting child thread",
            "subagent.created": "Child thread created",
            "subagent.create_failed": "Could not create child thread",
            "subagent.spawn_interrupted": "Spawn interrupted",
            "subagent.queued": "Queued for spawn",
            "subagent.preparing": "Preparing child thread",
            "subagent.working": "Still working",
            "subagent.finished": "Finished",
            "subagent.finished_error": "Finished with error",
            "subagent.stopped": "Stopped early",
            "subagent.waiting": "Waiting for updates",
            "subagent.processing": "Working on new instructions",
            "subagent.processed": "Processed the update",
            "subagent.update_failed": "Update failed",
            "subagent.update_interrupted": "Update interrupted",
            "subagent.queued_update": "Queued update",
            "subagent.instructions_sent": "Instructions sent",
            "subagent.back_to_work": "Back to work",
            "subagent.resumed_completed": "Resumed and completed",
            "subagent.resume_failed": "Resume failed",
            "subagent.resume_interrupted": "Resume interrupted",
            "subagent.queued_resume": "Queued to resume",
            "subagent.resuming": "Resuming agent",
            "subagent.closing": "Closing",
            "subagent.closed": "Closed",
            "subagent.close_failed": "Close failed",
            "subagent.close_interrupted": "Close interrupted",
            "subagent.queued_close": "Queued to close",
            "subagent.closing_agent": "Closing agent",
            "subagent.working_now": "Working now",
            "subagent.ended_error": "Ended with error",
            "subagent.idle": "Idle",

            // Onboarding
            "onboarding.install_codex": "Install Codex CLI",
            "onboarding.install_codex_desc": "The AI coding agent that lives in your terminal. MMS Remote connects to it from your iPhone.",
            "onboarding.install_bridge": "Install the Bridge",
            "onboarding.install_bridge_desc": "A lightweight relay that securely connects your Mac to your iPhone.",
            "onboarding.start_pairing": "Start Pairing",
            "onboarding.start_pairing_desc": "Run this on your computer. A QR code will appear in your terminal...",
            "onboarding.scan_qr": "Scan with QR Code",
            "onboarding.pair_with_code": "Pair with Code",
            "onboarding.get_started": "Get Started",
            "onboarding.set_up": "Set Up",
            "onboarding.continue": "Continue",
            "onboarding.continue_anyway": "Continue Anyway",
            "onboarding.step": "STEP %d",
            "onboarding.control_codex": "Control Codex from your iPhone.",
            "onboarding.e2ee": "End-to-end encrypted",
            "onboarding.what_you_get": "What you get",
            "onboarding.everything_local": "Everything runs on your computer.\nYour phone is the remote.",
            "onboarding.feature.fast": "Fast mode",
            "onboarding.feature.git": "Git from your phone",
            "onboarding.feature.e2ee": "End-to-end encrypted",
            "onboarding.feature.voice": "Voice mode",
            "onboarding.feature.subagents": "Subagents, skills and /commands",
            "onboarding.install_codex_first": "Install Codex CLI First",
            "onboarding.install_codex_hint": "Copy and paste \"%@\" on your computer before moving on. MMS Remote will not work until Codex CLI is installed and available in your PATH.",
            "onboarding.bridge_caption": "MMS Remote can keep your Mac awake with macOS caffeinate while the bridge is running, but it starts disabled by default. You can enable it later in Settings if you want.",
            ...
            "paywall.feature.fast.description": "Lower-latency turns for quick interactions",
            "paywall.feature.git.description": "Commit, push, pull, and switch branches",
            "paywall.feature.e2ee.description": "The relay never sees your prompts or code",
            "paywall.feature.voice.description": "Talk to Codex with speech-to-text",
            "paywall.feature.subagents.description": "Spawn and monitor parallel agents from your phone",
            "paywall.feature.skills.description": "Invoke skills, run slash commands, and mention files inline",
            "paywall.feature.relay.description": "You are paying for the product and the hosted path",
            "paywall.feature.support.description": "Help keep MMS Remote independent and open source",
