...
// Purpose: Dormant paywall shell retained for previews; source builds do not enable purchases.
// Layer: View
...
struct RevenueCatPaywallView: View {
    ...
    private var displayedPlans: [RevenueCatPaywallPreviewPlan] {
        ...
        // Maps configured package options into UI-facing plan cards without assuming every offer renews.
        return subscriptions.packageOptions.map { option in
            RevenueCatPaywallPreviewPlan(
                ...
                isBestValue: option.periodLabel.localizedCaseInsensitiveContains("year")
                    || option.title.localizedCaseInsensitiveContains("annual"),
    ...
    RevenueCatPaywallView(
        previewPlans: [
            RevenueCatPaywallPreviewPlan(
                ...
                isBestValue: false,
                callToActionTitle: "Unlock MMS Remote Pro",
