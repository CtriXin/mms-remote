...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update MMS Remote on your computer before scanning",
        message: "This QR code was generated by a different MMS Remote npm version. Update the package on your computer to the latest release before scanning a new QR code.",
...
private final class QRCameraLifecycleCoordinator {
    ...
    private let queue = DispatchQueue(label: "com.mmsremote.qr-camera.lifecycle")
