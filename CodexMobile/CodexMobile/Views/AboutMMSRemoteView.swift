// FILE: AboutMMSRemoteView.swift
// Purpose: Full-screen guide explaining how MMS Remote works, styled as a blog page.
// Layer: View
// Exports: AboutMMSRemoteView

import SwiftUI

struct AboutMMSRemoteView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .font(AppFont.body())
            .navigationTitle("About MMS Remote")
    ...
    @ViewBuilder private var architectureDiagram: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(spacing: 0) {
                diagramStep(from: "MMS Remote iOS", to: "Bridge (Mac)", via: "WebSocket")
    ...
    @ViewBuilder private var appServerSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            calloutCard(
                ...
                color: .orange,
                text: "Already have a running Codex instance? Point the bridge at it with MMS_REMOTE_CODEX_ENDPOINT instead of spawning a new one."
            )
        }
    }
    ...
    @ViewBuilder private var desktopSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            calloutCard(
                ...
                color: .blue,
                text: "The desktop app doesn't live-reload external writes. Use the desktop app handoff button in MMS Remote to continue the current thread on your computer."
            )
        }
    }
