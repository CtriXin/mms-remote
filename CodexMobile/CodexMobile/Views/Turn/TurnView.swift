    ...
    private func buildVoiceRecoveryPresentation(for reason: CodexVoiceFailureReason) -> VoiceRecoveryPresentation {
        ...
        case .reconnectRequired:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    ...
                    detail: "Keep the MMS Remote bridge running on your paired computer, then try the microphone again.",
                    status: .interrupted,
        ...
        case .bridgeSessionUnsupported:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    ...
                    detail: "Restart MMS Remote on your computer, then reconnect this iPhone. If it still happens, update MMS Remote on your computer and pair again.",
        ...
        case .microphonePermissionRequired:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    title: "Voice Mode",
                    summary: "Microphone access is off for MMS Remote.",
                    detail: "Open iPhone Settings, allow Microphone for MMS Remote, then try recording again.",
                    status: .actionRequired,
        ...
        case .recorderUnavailable:
            return VoiceRecoveryPresentation(
                snapshot: ConnectionRecoverySnapshot(
                    title: "Voice Mode",
                    summary: "MMS Remote could not start the recorder.",
