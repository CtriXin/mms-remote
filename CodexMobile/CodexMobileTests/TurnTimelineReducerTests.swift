...
final class TurnTimelineReducerTests: XCTestCase {
    ...
    func testTimelineProjectionKeepsPreviousMessagesChronologicalForMultiAssistantTurns() {
        ...
        let rawMessages = [
            ...
            makeMessage(
                ...
                threadID: "thread",
                role: .assistant,
                text: "The latest MMS Remote TestFlight inbox email says: Version 1.4, build 126.",
                createdAt: now.addingTimeInterval(3),
                turnID: "turn-1",
                itemID: "final-item-a",
                orderIndex: 4
    ...
    func testTimelineProjectionSkipsFinalReplaysAndMergedImageArtifactsInPreviousMessages() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                threadID: "thread",
                role: .assistant,
                text: "The site is for MMS Remote: an iPhone bridge with a local-first power-user tone.",
                createdAt: now.addingTimeInterval(2),
                turnID: "turn-1",
                orderIndex: 3
            ),
    ...
    func testRemoveDuplicateAssistantMessagesCollapsesLateReplaySubsetForSameTurn() {
        ...
        Latest TestFlight version: MMS Remote 1.4 (122) for iOS.
        """
        let replayText = "Latest TestFlight version: MMS Remote 1.4 (122) for iOS."
        let messages = [
            makeMessage(
                id: "assistant-final",
                threadID: "thread",
    ...
    func testProjectOrdersLateStatusBeforeFinalUsingCreatedAt() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                role: .assistant,
                kind: .chat,
                text: "Latest TestFlight inbox email says: MMS Remote version 1.4, build 124.",
                createdAt: now.addingTimeInterval(2),
                turnID: "turn-1",
                itemID: "item-final",
                orderIndex: 2
    ...
    func testAssistantBlockInfoDeduplicatesEquivalentSingleFileDiffSnapshots() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                Path: /Users/emanueledipietro/Developer/MMS Remote/CodexMobile/CodexMobile/Views/Turn/TurnMessageComponents.swift
                Kind: update
                Totals: +1 -0
    ...
    func testAssistantBlockInfoDoesNotDoubleCountIdenticalSummaryOnlySnapshots() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                Path: /Users/emanueledipietro/Developer/MMS Remote/Sources/App.swift
                Kind: update
                Totals: +2 -1
                """,
                createdAt: now.addingTimeInterval(2),
