...
final class CodexServiceIncomingRunIndicatorTests: XCTestCase {
    ...
    func testAssistantDeltaCoalescingAppliesOrderedDeltasOnFlush() {
        ...
        service.enqueueAssistantDelta(threadId: threadID, turnId: turnID, itemId: itemID, assistantPhase: nil, delta: "Hello")
        service.enqueueAssistantDelta(threadId: threadID, turnId: turnID, itemId: itemID, assistantPhase: nil, delta: " world")
    ...
    func testAssistantDeltaCoalescingMergesCumulativeSnapshotsBeforeFlush() {
        ...
        service.enqueueAssistantDelta(threadId: threadID, turnId: turnID, itemId: itemID, assistantPhase: nil, delta: "Yes")
        service.enqueueAssistantDelta(threadId: threadID, turnId: turnID, itemId: itemID, assistantPhase: nil, delta: "Yes, the")
        service.enqueueAssistantDelta(threadId: threadID, turnId: turnID, itemId: itemID, assistantPhase: nil, delta: "Yes, the imagegen skill")
    ...
    func testMacUnavailableCloseKeepsSavedPairingAndRetriesReconnect() {
        ...
        withSavedRelayPairing(sessionId: "session-\(UUID().uuidString)", relayURL: "wss://relay.test/relay") {
            ...
            XCTAssertEqual(
                service.lastErrorMessage,
                "The saved Mac session is temporarily unavailable. MMS Remote will keep retrying. If you restarted the bridge on your Mac, scan the new QR code."
            )
    ...
    func testTurnlessFinalThenTerminalReplayDoesNotDuplicateAssistantAnswer() {
        ...
        MMS Remote version 1.4, build 124

        Subject: "MMS Remote - Remote AI Coding 1.4 (124) for iOS is now available to test."
        """
