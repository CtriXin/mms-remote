...
final class QRScannerPairingValidatorTests: XCTestCase {
    func testVersionMismatchRequiresBridgeUpdateBeforeScanning() {
        ...
        XCTAssertEqual(prompt.title, "Update MMS Remote on your Mac before scanning")
        XCTAssertEqual(prompt.command, "npm install -g mms-remote@latest")
        XCTAssertTrue(prompt.message.contains("different MMS Remote npm version"))
    }
    ...
    func testLegacyBridgePayloadRequiresBridgeUpdateBeforeScanning() {
        ...
        XCTAssertEqual(prompt.command, "npm install -g mms-remote@latest")
        XCTAssertTrue(prompt.message.contains("older MMS Remote bridge"))
    }
